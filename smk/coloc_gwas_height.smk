configfile: "coloc_gwas_height.yaml"
GWAS_annots=["standing_height"]
ids=config["IDS"]
...
LD_files = get_LD_file("../../results/results_09232024/gwas_ukbb/continuous-50-both_sexes-irnt/continuous-50-both_sexes-irnt_leadvar.tsv")
...
rule all:
    input:
        ...
        #expand("../../results/results_03152025/{GWAS_annot}_susie_models/{LD_file}.susie.Rda", GWAS_annot=GWAS_annots, LD_file=LD_files),
        #expand("../../results/results_07142023/{GWAS_annot}_susie_models/{LD_file}_alignment.png", GWAS_annot=GWAS_annots, LD_file=LD_files),
        expand("../../results/results_03312025/GWAS_{GWAS_annot}_coloc/{celltype}_{region}/{LD_file}_res_summary_{filter_window}win.Rda", celltype=celltypes, region=regions, GWAS_annot=GWAS_annots, LD_file=LD_files, filter_window=filter_window),
        #expand("../../results/results_10282024/gwas_coloc_plots_{celltype}_{filter_window}win/{GWAS_annot}_{region}/locuscomapreplot/logs/{LD_file}_win_PPH4{PPH4_threshold}.tsv", 
        ...
        #expand('../../results/results_03282025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc.tsv', GWAS_annot=GWAS_annots),
...
rule runsusie:
    input:
        "../../results/results_09232024/gwas_ukbb/continuous-50-both_sexes-irnt/continuous-50-both_sexes-irnt_hg38.h.tsv"
    params:
    ...
    output:
        "../../results/results_03152025/{GWAS_annot}_susie_models/{LD_file}.susie.Rda"
    conda:
        "R423"
    envmodules:
        "Bioinformatics",
...
rule coloc:
    ...
    params:
        ...
        region="{region}",
    output:
        "../../results/results_03312025/GWAS_{GWAS_annot}_coloc/{celltype}_{region}/{LD_file}_res_summary_{filter_window}win.Rda"
    conda:
        "R423"
    envmodules:
        "Bioinformatics",
...
rule coloc_summary:
    input:
        "../../results/results_09232024/gwas_ukbb/continuous-50-both_sexes-irnt/continuous-50-both_sexes-irnt_leadvar.tsv"
    output:
        "../../results/results_03312025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc.tsv"
    params:
        GWAS_annot="{GWAS_annot}",
        rda_dir = '../../results/results_03312025/GWAS_{GWAS_annot}_coloc/',
        filter_window=config["filter_window"],
