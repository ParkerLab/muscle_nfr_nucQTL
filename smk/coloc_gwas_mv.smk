configfile: "coloc_gwas_mv.yaml"
GWAS_annots=["muscle_volume"]
ids=config["IDS"]
...
LD_files = get_LD_file("../../results/results_09232024/gwas_ukbb/continuous-22404-both_sexes-irnt/continuous-22404-both_sexes-irnt_leadvar.tsv")
...
rule all:
    input:
        ...
        expand("../../results/results_10282024/{GWAS_annot}_susie_models/{LD_file}.susie.Rda", GWAS_annot=GWAS_annots, LD_file=LD_files),
...
rule runsusie:
    input:
        "../../results/results_09232024/gwas_ukbb/continuous-22404-both_sexes-irnt/continuous-22404-both_sexes-irnt_hg38.h.tsv"
    params:
    ...
    output:
        "../../results/results_10282024/{GWAS_annot}_susie_models/{LD_file}.susie.Rda"
    conda:
        "R423"
    envmodules:
        "Bioinformatics",
