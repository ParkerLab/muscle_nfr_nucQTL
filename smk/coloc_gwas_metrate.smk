configfile: "coloc_gwas_metrate.yaml"
GWAS_annots=["basal_merabolic_rate"]
ids=config["IDS"]
...
LD_files = get_LD_file("../../results/results_09232024/gwas_ukbb/continuous-23105-both_sexes-irnt/continuous-23105-both_sexes-irnt_leadvar.tsv")
...
rule all:
    input:
        ...
        #expand("../../results/results_03132025/{GWAS_annot}_susie_models/{LD_file}_susie_dat.Rda", GWAS_annot=GWAS_annots, LD_file=LD_files),
        #expand("../../results/results_07142023/{GWAS_annot}_susie_models/{LD_file}_alignment.png", GWAS_annot=GWAS_annots, LD_file=LD_files),
        expand("../../results/results_03182025/GWAS_{GWAS_annot}_coloc/{celltype}_{region}/{LD_file}_res_summary_{filter_window}win.Rda", celltype=celltypes, region=regions, GWAS_annot=GWAS_annots, LD_file=LD_files, filter_window=filter_window),
        expand("../../results/results_03182025/gwas_coloc_plots_{celltype}_{filter_window}win/{GWAS_annot}_{region}/locuscomapreplot/logs/{LD_file}_win_PPH4{PPH4_threshold}.tsv", 
        ...
        expand("../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc.tsv", GWAS_annot=GWAS_annots),
        expand("../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc_{celltype}_chr{id}_inpeak.tsv", 
                celltype=celltypes, GWAS_annot=GWAS_annots, id=ids),
        expand("../../results/results_03182025/GWAS_{GWAS_annot}_coloc_inpeak/nfrqtls_{GWAS_annot}_gwas_coloc_{celltype}_inpeak.tsv",
                celltype=celltypes, GWAS_annot=GWAS_annots)



rule runsusie:
    input:
        "../../results/results_09232024/gwas_ukbb/continuous-23105-both_sexes-irnt/continuous-23105-both_sexes-irnt_hg38.h.tsv"
    params:
    ...
    output:
        "../../results/results_03132025/{GWAS_annot}_susie_models/{LD_file}_susie_dat.Rda"
    conda:
        "R423"
    envmodules:
        "Bioinformatics",
    ...
    shell:
        """
        Rscript ../../scripts/bin/runsusie_gwas_grip_strength.R \
...
rule coloc:
    input:
        "../../results/results_03132025/{GWAS_annot}_susie_models/{LD_file}.susie.Rda"
    params:
        LD_file = "{LD_file}",
        celltype="{celltype}",
        GWAS_annot="{GWAS_annot}",
        ...
        region="{region}",
    output:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc/{celltype}_{region}/{LD_file}_res_summary_{filter_window}win.Rda"
    conda:
        "R423"
    envmodules:
        "Bioinformatics",
...
rule tidy_coloc:
    input:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc/{celltype}_{region}/{LD_file}_res_summary_{filter_window}win.Rda"
    output:
        "../../results/results_03182025/gwas_coloc_plots_{celltype}_{filter_window}win/{GWAS_annot}_{region}/locuscomapreplot/logs/{LD_file}_win_PPH4{PPH4_threshold}.tsv"
    params:
        LD_file = "{LD_file}",
        celltype="{celltype}",
        outdir_coloc=config["outdir_coloc"],
...
# should have combine this with the above rule
rule coloc_summary:
    input:
        "../../results/results_09232024/gwas_ukbb/continuous-23105-both_sexes-irnt/continuous-23105-both_sexes-irnt_hg38.h.tsv"
    output:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc.tsv"
    params:
        GWAS_annot="{GWAS_annot}",
        rda_dir = '../../results/results_03182025/GWAS_{GWAS_annot}_coloc/',
        filter_window=config["filter_window"],
        outdir= '../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/'
    conda:
        "R423"
    shell:
        """
...
rule coloc_inpeak:
    input:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc.tsv"
    output:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc_{celltype}_chr{id}_inpeak.tsv"
    params:
        GWAS_annot="{GWAS_annot}",
...
rule coloc_inpeak_bind:
    input:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/nfrqtls_{GWAS_annot}_gwas_coloc_{celltype}_chr22_inpeak.tsv"
    output:
        "../../results/results_03182025/GWAS_{GWAS_annot}_coloc_inpeak/nfrqtls_{GWAS_annot}_gwas_coloc_{celltype}_inpeak.tsv"
    params:
        GWAS_annot="{GWAS_annot}",
        celltype="{celltype}",
        inpeak_dir="../../results/results_03182025/GWAS_{GWAS_annot}_coloc_summary/",
        outdir="../../results/results_03182025/GWAS_{GWAS_annot}_coloc_inpeak/"
    shell:
        """
